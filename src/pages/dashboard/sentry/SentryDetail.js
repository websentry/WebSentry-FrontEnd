          ...
          <DashboardLayout page='home'>
            ...
            <List loading={this.state.loading}>
              <Descriptions column={2} style={{ paddingBottom: '24px' }} bordered>
                <Descriptions.Item label='Create Time'>{moment.tz(this.state.data.createdAt, tz).format('MMMM Do YYYY, h:mm A')}</Descriptions.Item>
                <Descriptions.Item label='Last Check Time'>{moment.tz(this.state.data.lastCheckTime, tz).fromNow()}</Descriptions.Item>
              ...
              <Panel header='Screenshot History' key='1' showArrow={false}>
                <List 
                  ...
                  renderItem={item => (
                    ...
                    >
                      <List.Item.Meta
                        title={moment.tz(item.createdAt, tz).format('MMMM Do YYYY, h:mm A')}
